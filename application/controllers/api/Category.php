...
class Category extends REST_Controller {
	...
	{
        $data = $this->getbase->getinfo('category', $id);
    ...
    public function index_post()
    {
        ...
        try 
        {
            $retmsg = $this->getbase->insert('category', $inpt);
            if($retmsg['code']=='0') {
    ...
    public function index_put($id)
    {
        ...
        try 
        {
            $retmsg = $this->getbase->update('category', $inpt, $id);
            if($retmsg=='0') {
    ...
    public function index_delete($id)
    {
        try 
        {
            $this->getbase->delete('category', $id);
